 ...
 * @file		refl_clshdlr.h
 * @ingroup		refl
 * @brief		Interface for the command line shell handler of the SWC @a refl
 *
 * This header files provides the interface from the SWC @refl REFL to the SWC @ref sh.
...
/**
 * @brief Parses a command of the software component 'Reflectance Sensor Array'
