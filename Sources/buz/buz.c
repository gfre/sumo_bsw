 ...
 *
 * This module implements a driver component for a buzzer by means of a trigger component provided
 * and enhanced by the firmware components @b TRG1 and @b BUZ1.
 *
