...
{
		{PID_LFT_MTR_SPD_STR,  PID_LFT_MTR_SPD,  &LftSpdCfg,  PID_NO_SAT, 0, 0, TACHO_Read_SpdLft,  DRV_Read_LftSpdTrgtVal,  NVM_Read_PIDSpdLeCfg, NVM_Read_Dflt_PIDSpdLeCfg, NVM_Save_PIDSpdLeCfg},
		{PID_RGHT_MTR_SPD_STR, PID_RGHT_MTR_SPD, &RghtSpdCfg, PID_NO_SAT, 0, 0, TACHO_Read_SpdRght, DRV_Read_RghtSpdTrgtVal, NVM_Read_PIDSpdRiCfg, NVM_Read_Dflt_PIDSpdRiCfg, NVM_Save_PIDSpdRiCfg},
